...
const DIESEL_GENERATOR_ASSET_FIELDS = [
  ...
  { name: "manufacturer", label: "Manufacturer", aiReadable: true },
  { name: "model", label: "Model", aiReadable: true },
  { name: "serial", label: "Serial", mono: true, aiReadable: true },
  { name: "engineManufacturer", label: "Engine Manufacturer", aiReadable: true },
  { name: "engineModel", label: "Engine Model", aiReadable: true },
  { name: "kwRating", label: "kW Rating", aiReadable: true },
  { name: "voltage", label: "Voltage", aiReadable: true },
  { name: "fuelTankCapacityGal", label: "Fuel Tank Capacity (gal)", aiReadable: true },
...
const FIRE_PUMP_ASSET_FIELDS_BASE = [
  ...
  { name: "manufacturer", label: "Pump Manufacturer", aiReadable: true },
  { name: "model", label: "Pump Model", aiReadable: true },
  { name: "serial", label: "Pump Serial #", mono: true, aiReadable: true },
  { name: "ratedRpm", label: "Rated RPM", aiReadable: true },
  { name: "controllerManufacturer", label: "Controller Mfr.", aiReadable: true },
  { name: "controllerModel", label: "Controller Model", aiReadable: true },
  { name: "controllerSerial", label: "Controller S/N", mono: true, aiReadable: true },
  { name: "maxSuctionPressurePsi", label: "Max Suction Pressure (psi)", aiReadable: true },
  { name: "maxPsiShutoff", label: "Max PSI (Shutoff)", aiReadable: true },
  { name: "ratedCapacityGpm", label: "Rated Capacity (gpm)", aiReadable: true },
  { name: "ratedPressurePsi", label: "Rated Pressure (psi)", aiReadable: true },
  { name: "overloadCapacityGpm", label: "150% Rated Capacity (gpm)", aiReadable: true },
  { name: "overloadPressurePsi", label: "Rated Pressure @ Rated Capacity (psi)", aiReadable: true },
  { name: "driverManufacturer", label: "Driver Mfr.", aiReadable: true },
  { name: "driverModel", label: "Driver Model", aiReadable: true },
  { name: "driverRatedRpm", label: "Driver Rated RPM", aiReadable: true },
];

const ELECTRIC_FIRE_PUMP_ASSET_FIELDS = [
  ...FIRE_PUMP_ASSET_FIELDS_BASE,
  { name: "fullLoadAmp", label: "Full Load Amp (FLA)", aiReadable: true },
  { name: "ratedVoltage", label: "Rated Voltage", aiReadable: true },
  { name: "serviceFactor", label: "Service Factor (SF)", aiReadable: true },
  { name: "dateInstalled", label: "Date Installed", type: "date" },
  { name: "notes", label: "Notes", multiline: true, span: 2 },
];
